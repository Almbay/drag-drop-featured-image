<?php
	...
	*/
	...
	function dgd_loadPanelScripts(){
		...
		wp_register_script('njquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js');
		wp_register_script('itoggle_script', $pluginDir.'includes/scripts/engage.itoggle-min.js', 'jquery');
	...
	function dgd_setMenuPage(){
		add_theme_page('Options for Drag & Drop Featured Image', __('D&D Featured Image'), 'manage_options', 'drag-drop-featured-image/drag-to-feature.php', '');
	}
