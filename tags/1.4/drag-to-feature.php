					...
					<div id="itoggle" class="inside" style="padding: 20px 30px;">
						<form action="" method="post">
							...
							<?php if (current_user_can('manage_options')): ?>
								<strong>Change the capability required to customize the plugin settings</strong><br />
								<small><em>The default capability is <code>manage_options</code> and applies to administrators. </em></small><br />
								...
								<small>&nbsp;&nbsp;<a href="http://codex.wordpress.org/Roles_and_Capabilities" target="_blank">User roles &amp; capabilities &raquo;</a></small>
								<br /><br />
							<?php endif; ?>
