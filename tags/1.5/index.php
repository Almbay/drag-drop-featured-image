<?php
	...
	*/
	...
	function dgd_loadPanelScripts($hook){
		...
		// Post edit screen:
		if ($hook === 'post.php' || $hook === 'post-new.php' || $hook === 'media-upload-popup'){
	...
	function dgd_setMenuPage(){
		...
		add_theme_page(__('Options for Drag & Drop Featured Image', 'dgdfi'), __('D&D Featured Image', 'dgdfi'), $required_capability, 'drag-drop-featured-image/drag-to-feature.php', '');
	}
