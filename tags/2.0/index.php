<?php
	...
	/*
		...
		Description: A drag'n'drop replacement for the build in featured image meta box.
		Version: 2.0
	...
	*/
	...
	class WP_Drag_Drop_Featured_Image {
		...
		public function __construct(){
			...
			$this->plugin_directory = plugins_url('drag-drop-featured-image').'/';
		...
		public function get_option_user_capability(){
			return get_option('drag-drop-user-capability');
		}
		...
		public function add_admin_menu_page(){
			...
			add_options_page(__('Options for Drag & Drop Featured Image', $this->plugin_locale), __('Featured Image', $this->plugin_locale), $required_capability, $this->plugin_options_slug, array(&$this, 'render_options_page'));
		}
						...
						<div id="drag-drop-area">
							<div class="drag-drop-inside">
								...
								<p class="drag-drop-buttons">
									<?php
										global $wp_version;
										$current_version = substr(str_replace('.', '', $wp_version), 0, 2);
									?>
									<?php if ($current_version >= 35): ?>
